 ...
 * @author kresn
 */
public class ShowAllTemperature extends ShowFromCategory {
    ...
    public ShowAllTemperature(int totalSensor, int speedSensor) throws InterruptedException {
        JFrame frame = new JFrame("Category : Temperature");
        ...
        if (totalSensor == 3) {
            ...
            this.panel2 = new Panel(Color.white, "20", "30", "40", dataInput, Color.YELLOW, this.speedSensor);
            this.panel2.setBorder(BorderFactory.createLineBorder(Color.white, 2));

            this.panel3 = new Panel(Color.white, "20", "30", "40", dataInput, Color.BLUE, this.speedSensor);
            ...
            this.panel4 = new Panel(Color.white, "20", "30", "40", dataInput, Color.GREEN, this.speedSensor);
            this.panel4.setBorder(BorderFactory.createLineBorder(Color.white, 2));

            this.panel5 = new Panel(Color.white, "20", "30", "40", dataInput, Color.ORANGE, this.speedSensor);
            this.panel5.setBorder(BorderFactory.createLineBorder(Color.white, 2));

            this.panel6 = new Panel(Color.white, "20", "30", "40", dataInput, Color.CYAN, this.speedSensor);
            ...
            this.panel7 = new Panel(Color.white, "20", "30", "40", dataInput, Color.PINK, this.speedSensor);
            this.panel7.setBorder(BorderFactory.createLineBorder(Color.white, 2));

            this.panel8 = new Panel(Color.white, "20", "30", "40", dataInput, Color.DARK_GRAY, this.speedSensor);
            this.panel8.setBorder(BorderFactory.createLineBorder(Color.white, 2));

            this.panel9 = new Panel(Color.white, "20", "30", "40", dataInput, Color.MAGENTA, this.speedSensor);
    ...
    public void deployPanelInformation() {
        ...
        for (Panel pan : listPanels) {
            ...
            JTextField sensorName = new JTextField();
            if (this.listSensors.isEmpty()) {
                sensorName = new JTextField("SENSOR : cant't read sensor name");
            } else {
                sensorName = new JTextField("SENSOR : " + this.listSensors.get(index));
            }
    ...
    public void runVisualization() {
        if (this.totalSensor == 3) {
            Thread runThread1 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel1, listSensors.get(0), 3);
                }
            };
            ...
            Thread runThread2 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel2, listSensors.get(1), 3);
                }
            };
            ...
            Thread runThread3 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel3, listSensors.get(2), 3);
                }
            };
            runThread1.start();
            runThread2.start();
            ...
            Thread runThread1 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel1, listSensors.get(0), 6);
                }
            };
            ...
            Thread runThread2 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel2, listSensors.get(1), 6);
                }
            };
            ...
            Thread runThread3 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel3, listSensors.get(2), 6);
                }
            };
            ...
            Thread runThread4 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel4, listSensors.get(3), 6);
                }
            };
            Thread runThread5 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel5, listSensors.get(4), 6);
                }
            };
            ...
            Thread runThread6 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel6, listSensors.get(5), 6);
                }
            };
            runThread1.start();
            runThread2.start();
            ...
            Thread runThread1 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel1, listSensors.get(0), 9);
                }
            };
            ...
            Thread runThread2 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel2, listSensors.get(1), 9);
                }
            };
            ...
            Thread runThread3 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel3, listSensors.get(2), 9);
                }
            };
            ...
            Thread runThread4 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel4, listSensors.get(3), 9);
                }
            };
            Thread runThread5 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel5, listSensors.get(4), 9);
                }
            };
            ...
            Thread runThread6 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel6, listSensors.get(5), 9);
                }
            };
            ...
            Thread runThread7 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel7, listSensors.get(6), 9);
                }
            };
            ...
            Thread runThread8 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel8, listSensors.get(7), 9);
                }
            };
            ...
            Thread runThread9 = new Thread() {
                @Override
                public void run() {
                    dataInput.readDataOnlyTemperature(panel9, listSensors.get(8), 9);
                }
            };
            runThread1.start();
            runThread2.start();
